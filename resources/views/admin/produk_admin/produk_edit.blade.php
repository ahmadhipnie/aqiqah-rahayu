                ...
                <div class="card-body">
                    <form action="{{ route('admin.produk.update', $produk->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="jumlah_porsi" id="jumlah_porsi" class="form-control" value="{{ $produk->jumlah_porsi }}" required>
                        </div>
                        <div class="mb-3">
                            <label for="deskripsi_produk" class="form-label">Deskripsi Produk</label>
                            <textarea name="deskripsi_produk" id="summernote" class="form-control" required>{{ $produk->deskripsi_produk }}</textarea>
                        </div>
                        <div class="mb-3">
                            ...
                            @if($produk->gambar_produk)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/gambar_produk/'.$produk->gambar_produk) }}" width="120">
                                </div>
                            @endif
                        </div>
